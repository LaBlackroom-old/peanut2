<nav>
  <ul>
    <li><a href="#" class="nav-top-item <?php if($sf_context->getModuleName() == 'adminItem' || $sf_context->getModuleName() == 'adminPage' || $sf_context->getModuleName() == 'adminLink'): echo 'current'; endif; ?>" title="<?php echo __('Liens d\'accès'); ?>"><?php echo __('Manage items'); ?></a>
      <ul>
